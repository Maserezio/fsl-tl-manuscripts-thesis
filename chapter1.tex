...
\Gls{tls} is an important step in document analysis, since its quality affects downstream \gls{ocr} and \gls{htr} results \cite{fizaine}. For historical manuscripts, this task is particularly challenging for two reasons: physical degradations, such as ink bleeding and faded sections \cite{Rabaev_Litvak_2025}, and varying writing styles both within and between documents, text orientation, and overlapping lines and characters \cite{diva_hisdb}.
