...
\begin{itemize}
    \item compare convolutional-based and transformer-based encoders across different text line segmentation architectures;
...
\begin{itemize}
    ...
    \item Chapter 4 describes the methodology for solving the research questions, FSL model architectures and parameters (such as backbone weights, postprocessing algorithms, where applicable), experimental design, and text line detection metrics.
