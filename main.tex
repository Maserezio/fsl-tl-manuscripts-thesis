...
\newacronym{cbad}{cBAD}{Competition on Baseline Detection}
...
\newacronym{fm}{FM}{F-Measure}
\newacronym{fsl}{FSL}{Few-Shot Learning}
\newacronym{htr}{HTR}{Handwritten Text Recognition}
\newacronym{iou}{IoU}{Intersection over Union}
\newacronym{lineiu}{Line IU}{Line Intersection over Union}
\newacronym{ocr}{OCR}{Optical Character Recognition}
\newacronym{pixeliu}{Pixel IU}{Pixel Intersection over Union}
\newacronym{pspnet}{PSPNet}{Pyramid Scene Parsing Network}
\newacronym{ra}{RA}{Recognition Accuracy}
\newacronym{rq}{RQ}{Research Question}
\newacronym{sota}{SOTA}{State of the Art}
\newacronym{tls}{TLS}{Text Line Segmentation}
...
\begin{abstract}
    \Gls{tls} is a preprocessing step in the document analysis
    pipeline performed before \gls{ocr} or
    \gls{htr}, and its quality directly affects
...
% Expand acronyms again in the main text after the self-contained abstract.
\glsresetall
...
\begin{aitools}
    ...
    \begin{itemize}
        \item \textbf{Claude} (Anthropic): used for code generation.
        \item \textbf{ChatGPT (GPT-4, GPT-5)} (OpenAI): used for code generation and syntax checking.
        \item \textbf{Grammarly}: used for syntax checking.
    \end{itemize}
